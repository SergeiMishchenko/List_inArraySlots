...
public class List_inArraySlots {
    ...
    /**
      ...
      precondition: @index is within the bounds of the elements.
     ...
     */
     public int remove( int index) {
		int cycleI;
		int removedV = elements[index];
		for (cycleI = index; cycleI < size(); cycleI++) {
			elements[cycleI] = elements[cycleI + 1];
		}
		elements[cycleI] = -1; //arbitrary placeholder value
		return removedV;
    }
